    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
		 ...
		 <div class="alert alert-danger">
                          ...
                          <center> <h3><strong>Orders</strong> </h3></center>
            ...
            <table class="display table table-bordered" id="example" cellspacing="0" width="100%">
			  ...
			  <?php
include("config.php");
	$stmt = $DB_con->prepare('select order_id, order_date,users.user_firstname, users.user_lastname,users.user_telephone,users.user_address,users.province,users.district,users.sector,users.cell,users.streetno ,order_name, order_price, order_quantity, order_total from orderdetails, users where orderdetails.user_id=users.user_id and order_status="Ordered" order by order_date desc');
	$stmt->execute();
		...
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
		{
			...
			?>
                <tr>
				 ...
				 <td><B>RWF:</b> <?php echo $order_price; ?></td>
				 <td><?php echo $order_quantity; ?></td>
				 <td><B>RWF:</b>  <?php echo $order_total; ?></td>
				...
				<a class="btn btn-danger" href="?delete_id=<?php echo $row['order_id']; ?>" title="click for delete" onclick="return confirm('Are you sure to remove this item ordered?')">
				  ...
				  Remove Item </a>
					 <a class="btn btn-info" href="#" title="click for delete" onclick="return confirm('Are you sure to Deliver this item ordered?')">
